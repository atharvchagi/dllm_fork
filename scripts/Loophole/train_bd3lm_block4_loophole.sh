#!/usr/bin/env bash
#SBATCH --job-name=bd3lm-b4-loophole
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:8
...
WANDB_MODE=online WANDB_PROJECT="bd3lm-experiments" \
  ...
  --save_strategy epoch \
  --logging_steps 10 \
  --run_name qwen3-0.6b-bd3lm-block4-loophole-mix60k-len4096-5ep \
  --output_dir /scratch/project/prj-02-pi-shuiwang-ji/atharvchagi/SC-models/a2d/Qwen3-0.6B-a2d-init/bd3lm/block4/len4096/loophole
