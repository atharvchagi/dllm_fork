...
# Run directly with: bash /nvme-data/neeleshgarg/repos/dllm_fork/scripts/relay/train/qwen_0.6b_bd3lm_block4_k2.sh
...
WANDB_MODE=online WANDB_PROJECT="block-relay" accelerate launch \
  ...
  --num_proc 8 \
  --loss_type BPTT \
  --model_name_or_path /nvme-data/neeleshgarg/repos/dllm_fork/.models/Qwen/Qwen3-0.6b-a2d-init \
  ...
  --output_dir /nvme-data/neeleshgarg/repos/dllm_fork/.models/Qwen/Qwen3-0.6b-a2d-init/bd3lm/relay_block4_k2_5ep
